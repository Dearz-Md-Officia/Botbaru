...
const client = makeWaSocket({ logger: pino ({ level: 'silent' }), printQRInTerminal: true, auth: state, browser: ["SC Simple By Dearz-MD", "Dekstop", "3.0"]})
console.log(color('[ SC BY DearzMD ]\n', 'red'),color('\nInfo Script :\n➸ Baileys : Multi Device\n➸ Nama Script : Dearz-MD\n➸ Creator : DEARZ\n\nFollow My Social Media Account All Yes :\n➸ My Youtube : Dearz-MD OFFICIAL`\n➸ My Instagram : @moontxml.id\n\nDonase Me For Support :\n➸ DONASI : https://saweria.co/DearzAdminMd\n\nThanks\n', 'red'))
...
sendMessage(`6283854436555@s.whatsapp.net`,{text: txt, mentions : [user]})
}
if (connection === 'close') {
